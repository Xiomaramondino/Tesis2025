...
class AdminController extends Controller
{
    public function index()
    {
        ...
        // Obtener solo usuarios directivos del mismo colegio
        ...
        // Obtener solo lectores del mismo colegio (asumo que idrol = 3 es para los lectores)
    ...
    public function guardarUsuario()
    {
        ...
        // Obtener el idcolegio desde la sesión
    ...
    public function eliminarDirectivo($idusuario)
    {
        ...
        // Redirigir de vuelta a la vista de administración
        return redirect()->to('/vista_admin');
    }
...
private function _enviarCorreoRecuperacionInicial($email, $usuario, $token)
{
    ...
    $mensaje = "
        ...
        <p>Tu nombre de usuario es: $usuario </strong></p>
